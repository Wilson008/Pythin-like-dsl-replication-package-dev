...
public class MyCsmParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(MyCsmGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyCsmGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getStepAccess().getAlternatives(), "rule__Step__Alternatives");
			builder.put(grammarAccess.getGeneralResourceAccess().getAlternatives(), "rule__GeneralResource__Alternatives");
			builder.put(grammarAccess.getPathConnectionAccess().getAlternatives(), "rule__PathConnection__Alternatives");
			builder.put(grammarAccess.getActiveResourceAccess().getAlternatives(), "rule__ActiveResource__Alternatives");
			...
			builder.put(grammarAccess.getCSMAccess().getGroup(), "rule__CSM__Group__0");
			builder.put(grammarAccess.getCSMAccess().getGroup_5(), "rule__CSM__Group_5__0");
			builder.put(grammarAccess.getCSMAccess().getGroup_10(), "rule__CSM__Group_10__0");
			builder.put(grammarAccess.getCSMAccess().getGroup_15(), "rule__CSM__Group_15__0");
			builder.put(grammarAccess.getCSMAccess().getGroup_17(), "rule__CSM__Group_17__0");
			builder.put(grammarAccess.getCSMAccess().getGroup_17_3(), "rule__CSM__Group_17_3__0");
			builder.put(grammarAccess.getScenarionAccess().getGroup(), "rule__Scenarion__Group__0");
			builder.put(grammarAccess.getScenarionAccess().getGroup_5(), "rule__Scenarion__Group_5__0");
			builder.put(grammarAccess.getScenarionAccess().getGroup_10(), "rule__Scenarion__Group_10__0");
			builder.put(grammarAccess.getScenarionAccess().getGroup_12(), "rule__Scenarion__Group_12__0");
			builder.put(grammarAccess.getScenarionAccess().getGroup_12_3(), "rule__Scenarion__Group_12_3__0");
			builder.put(grammarAccess.getMessageAccess().getGroup(), "rule__Message__Group__0");
			builder.put(grammarAccess.getWorkloadAccess().getGroup(), "rule__Workload__Group__0");
			builder.put(grammarAccess.getWorkloadAccess().getGroup_3(), "rule__Workload__Group_3__0");
			...
			builder.put(grammarAccess.getStartAccess().getGroup_7(), "rule__Start__Group_7__0");
			builder.put(grammarAccess.getStartAccess().getGroup_7_3(), "rule__Start__Group_7_3__0");
			builder.put(grammarAccess.getStopAccess().getGroup(), "rule__Stop__Group__0");
			builder.put(grammarAccess.getStopAccess().getGroup_4(), "rule__Stop__Group_4__0");
			builder.put(grammarAccess.getStopAccess().getGroup_5(), "rule__Stop__Group_5__0");
			builder.put(grammarAccess.getStopAccess().getGroup_6(), "rule__Stop__Group_6__0");
			builder.put(grammarAccess.getStopAccess().getGroup_7(), "rule__Stop__Group_7__0");
			builder.put(grammarAccess.getStopAccess().getGroup_7_3(), "rule__Stop__Group_7_3__0");
			builder.put(grammarAccess.getResourceAcquireAccess().getGroup(), "rule__ResourceAcquire__Group__0");
			builder.put(grammarAccess.getResourceAcquireAccess().getGroup_4(), "rule__ResourceAcquire__Group_4__0");
			builder.put(grammarAccess.getResourceAcquireAccess().getGroup_5(), "rule__ResourceAcquire__Group_5__0");
			builder.put(grammarAccess.getResourceAcquireAccess().getGroup_6(), "rule__ResourceAcquire__Group_6__0");
			builder.put(grammarAccess.getResourceAcquireAccess().getGroup_7(), "rule__ResourceAcquire__Group_7__0");
			builder.put(grammarAccess.getResourceAcquireAccess().getGroup_8(), "rule__ResourceAcquire__Group_8__0");
			builder.put(grammarAccess.getResourceAcquireAccess().getGroup_8_3(), "rule__ResourceAcquire__Group_8_3__0");
			builder.put(grammarAccess.getResourceReleaseAccess().getGroup(), "rule__ResourceRelease__Group__0");
			builder.put(grammarAccess.getResourceReleaseAccess().getGroup_4(), "rule__ResourceRelease__Group_4__0");
			builder.put(grammarAccess.getResourceReleaseAccess().getGroup_5(), "rule__ResourceRelease__Group_5__0");
			builder.put(grammarAccess.getResourceReleaseAccess().getGroup_6(), "rule__ResourceRelease__Group_6__0");
			builder.put(grammarAccess.getResourceReleaseAccess().getGroup_7(), "rule__ResourceRelease__Group_7__0");
			builder.put(grammarAccess.getResourceReleaseAccess().getGroup_8(), "rule__ResourceRelease__Group_8__0");
			builder.put(grammarAccess.getResourceReleaseAccess().getGroup_8_3(), "rule__ResourceRelease__Group_8_3__0");
			...
			builder.put(grammarAccess.getJoinAccess().getGroup_5_3(), "rule__Join__Group_5_3__0");
			builder.put(grammarAccess.getJoinAccess().getGroup_6(), "rule__Join__Group_6__0");
			builder.put(grammarAccess.getJoinAccess().getGroup_6_3(), "rule__Join__Group_6_3__0");
			builder.put(grammarAccess.getForkAccess().getGroup(), "rule__Fork__Group__0");
			builder.put(grammarAccess.getForkAccess().getGroup_4(), "rule__Fork__Group_4__0");
			builder.put(grammarAccess.getForkAccess().getGroup_5(), "rule__Fork__Group_5__0");
			builder.put(grammarAccess.getForkAccess().getGroup_5_3(), "rule__Fork__Group_5_3__0");
			builder.put(grammarAccess.getForkAccess().getGroup_6(), "rule__Fork__Group_6__0");
			builder.put(grammarAccess.getForkAccess().getGroup_6_3(), "rule__Fork__Group_6_3__0");
			builder.put(grammarAccess.getMergeAccess().getGroup(), "rule__Merge__Group__0");
			builder.put(grammarAccess.getMergeAccess().getGroup_4(), "rule__Merge__Group_4__0");
			builder.put(grammarAccess.getMergeAccess().getGroup_5(), "rule__Merge__Group_5__0");
			builder.put(grammarAccess.getMergeAccess().getGroup_5_3(), "rule__Merge__Group_5_3__0");
			builder.put(grammarAccess.getMergeAccess().getGroup_6(), "rule__Merge__Group_6__0");
			builder.put(grammarAccess.getMergeAccess().getGroup_6_3(), "rule__Merge__Group_6_3__0");
			...
			builder.put(grammarAccess.getBranchAccess().getGroup_6(), "rule__Branch__Group_6__0");
			builder.put(grammarAccess.getBranchAccess().getGroup_6_3(), "rule__Branch__Group_6_3__0");
			builder.put(grammarAccess.getSeqenceAccess().getGroup(), "rule__Seqence__Group__0");
			builder.put(grammarAccess.getSeqenceAccess().getGroup_4(), "rule__Seqence__Group_4__0");
			builder.put(grammarAccess.getSeqenceAccess().getGroup_5(), "rule__Seqence__Group_5__0");
			builder.put(grammarAccess.getSeqenceAccess().getGroup_5_3(), "rule__Seqence__Group_5_3__0");
			builder.put(grammarAccess.getSeqenceAccess().getGroup_6(), "rule__Seqence__Group_6__0");
			builder.put(grammarAccess.getSeqenceAccess().getGroup_6_3(), "rule__Seqence__Group_6_3__0");
			builder.put(grammarAccess.getProcessingResourceAccess().getGroup(), "rule__ProcessingResource__Group__0");
			builder.put(grammarAccess.getProcessingResourceAccess().getGroup_4(), "rule__ProcessingResource__Group_4__0");
			builder.put(grammarAccess.getProcessingResourceAccess().getGroup_4_3(), "rule__ProcessingResource__Group_4_3__0");
			builder.put(grammarAccess.getProcessingResourceAccess().getGroup_5(), "rule__ProcessingResource__Group_5__0");
			builder.put(grammarAccess.getProcessingResourceAccess().getGroup_5_3(), "rule__ProcessingResource__Group_5_3__0");
			builder.put(grammarAccess.getProcessingResourceAccess().getGroup_6(), "rule__ProcessingResource__Group_6__0");
			builder.put(grammarAccess.getProcessingResourceAccess().getGroup_6_3(), "rule__ProcessingResource__Group_6_3__0");
			builder.put(grammarAccess.getExternalServiceAccess().getGroup(), "rule__ExternalService__Group__0");
			builder.put(grammarAccess.getExternalServiceAccess().getGroup_4(), "rule__ExternalService__Group_4__0");
			builder.put(grammarAccess.getExternalServiceAccess().getGroup_4_3(), "rule__ExternalService__Group_4_3__0");
			builder.put(grammarAccess.getExternalServiceAccess().getGroup_5(), "rule__ExternalService__Group_5__0");
			builder.put(grammarAccess.getExternalServiceAccess().getGroup_5_3(), "rule__ExternalService__Group_5_3__0");
			builder.put(grammarAccess.getExternalServiceAccess().getGroup_6(), "rule__ExternalService__Group_6__0");
			builder.put(grammarAccess.getExternalServiceAccess().getGroup_6_3(), "rule__ExternalService__Group_6_3__0");
			...
			builder.put(grammarAccess.getCSMAccess().getStepAssignment_4(), "rule__CSM__StepAssignment_4");
			builder.put(grammarAccess.getCSMAccess().getStepAssignment_5_1(), "rule__CSM__StepAssignment_5_1");
			builder.put(grammarAccess.getCSMAccess().getGeneralResourceAssignment_9(), "rule__CSM__GeneralResourceAssignment_9");
			builder.put(grammarAccess.getCSMAccess().getGeneralResourceAssignment_10_1(), "rule__CSM__GeneralResourceAssignment_10_1");
			builder.put(grammarAccess.getCSMAccess().getScenarionAssignment_14(), "rule__CSM__ScenarionAssignment_14");
			builder.put(grammarAccess.getCSMAccess().getScenarionAssignment_15_1(), "rule__CSM__ScenarionAssignment_15_1");
			builder.put(grammarAccess.getCSMAccess().getMessageAssignment_17_2(), "rule__CSM__MessageAssignment_17_2");
			builder.put(grammarAccess.getCSMAccess().getMessageAssignment_17_3_1(), "rule__CSM__MessageAssignment_17_3_1");
			builder.put(grammarAccess.getScenarionAccess().getRootAssignment_4(), "rule__Scenarion__RootAssignment_4");
			builder.put(grammarAccess.getScenarionAccess().getRootAssignment_5_1(), "rule__Scenarion__RootAssignment_5_1");
			builder.put(grammarAccess.getScenarionAccess().getStepAssignment_9(), "rule__Scenarion__StepAssignment_9");
			builder.put(grammarAccess.getScenarionAccess().getStepAssignment_10_1(), "rule__Scenarion__StepAssignment_10_1");
			builder.put(grammarAccess.getScenarionAccess().getPathconnectionAssignment_12_2(), "rule__Scenarion__PathconnectionAssignment_12_2");
			builder.put(grammarAccess.getScenarionAccess().getPathconnectionAssignment_12_3_1(), "rule__Scenarion__PathconnectionAssignment_12_3_1");
			builder.put(grammarAccess.getMessageAccess().getNameAssignment_2(), "rule__Message__NameAssignment_2");
			builder.put(grammarAccess.getWorkloadAccess().getValueAssignment_3_1(), "rule__Workload__ValueAssignment_3_1");
			builder.put(grammarAccess.getStartAccess().getNameAssignment_2(), "rule__Start__NameAssignment_2");
			builder.put(grammarAccess.getStartAccess().getPostPathAssignment_4_1(), "rule__Start__PostPathAssignment_4_1");
			builder.put(grammarAccess.getStartAccess().getPrePathAssignment_5_1(), "rule__Start__PrePathAssignment_5_1");
			builder.put(grammarAccess.getStartAccess().getActiveResourceAssignment_6_1(), "rule__Start__ActiveResourceAssignment_6_1");
			builder.put(grammarAccess.getStartAccess().getWorkloadAssignment_7_2(), "rule__Start__WorkloadAssignment_7_2");
			builder.put(grammarAccess.getStartAccess().getWorkloadAssignment_7_3_1(), "rule__Start__WorkloadAssignment_7_3_1");
			builder.put(grammarAccess.getStopAccess().getNameAssignment_2(), "rule__Stop__NameAssignment_2");
			builder.put(grammarAccess.getStopAccess().getPostPathAssignment_4_1(), "rule__Stop__PostPathAssignment_4_1");
			builder.put(grammarAccess.getStopAccess().getPrePathAssignment_5_1(), "rule__Stop__PrePathAssignment_5_1");
			builder.put(grammarAccess.getStopAccess().getActiveResourceAssignment_6_1(), "rule__Stop__ActiveResourceAssignment_6_1");
			builder.put(grammarAccess.getStopAccess().getWorkloadAssignment_7_2(), "rule__Stop__WorkloadAssignment_7_2");
			builder.put(grammarAccess.getStopAccess().getWorkloadAssignment_7_3_1(), "rule__Stop__WorkloadAssignment_7_3_1");
			builder.put(grammarAccess.getResourceAcquireAccess().getNameAssignment_2(), "rule__ResourceAcquire__NameAssignment_2");
			builder.put(grammarAccess.getResourceAcquireAccess().getPostPathAssignment_4_1(), "rule__ResourceAcquire__PostPathAssignment_4_1");
			builder.put(grammarAccess.getResourceAcquireAccess().getPrePathAssignment_5_1(), "rule__ResourceAcquire__PrePathAssignment_5_1");
			builder.put(grammarAccess.getResourceAcquireAccess().getActiveResourceAssignment_6_1(), "rule__ResourceAcquire__ActiveResourceAssignment_6_1");
			builder.put(grammarAccess.getResourceAcquireAccess().getGeneralResourceAssignment_7_1(), "rule__ResourceAcquire__GeneralResourceAssignment_7_1");
			builder.put(grammarAccess.getResourceAcquireAccess().getWorkloadAssignment_8_2(), "rule__ResourceAcquire__WorkloadAssignment_8_2");
			builder.put(grammarAccess.getResourceAcquireAccess().getWorkloadAssignment_8_3_1(), "rule__ResourceAcquire__WorkloadAssignment_8_3_1");
			builder.put(grammarAccess.getResourceReleaseAccess().getNameAssignment_2(), "rule__ResourceRelease__NameAssignment_2");
			builder.put(grammarAccess.getResourceReleaseAccess().getPostPathAssignment_4_1(), "rule__ResourceRelease__PostPathAssignment_4_1");
			builder.put(grammarAccess.getResourceReleaseAccess().getPrePathAssignment_5_1(), "rule__ResourceRelease__PrePathAssignment_5_1");
			builder.put(grammarAccess.getResourceReleaseAccess().getActiveResourceAssignment_6_1(), "rule__ResourceRelease__ActiveResourceAssignment_6_1");
			builder.put(grammarAccess.getResourceReleaseAccess().getGeneralResourceAssignment_7_1(), "rule__ResourceRelease__GeneralResourceAssignment_7_1");
			builder.put(grammarAccess.getResourceReleaseAccess().getWorkloadAssignment_8_2(), "rule__ResourceRelease__WorkloadAssignment_8_2");
			builder.put(grammarAccess.getResourceReleaseAccess().getWorkloadAssignment_8_3_1(), "rule__ResourceRelease__WorkloadAssignment_8_3_1");
			builder.put(grammarAccess.getJoinAccess().getNameAssignment_2(), "rule__Join__NameAssignment_2");
			builder.put(grammarAccess.getJoinAccess().getMessageAssignment_4_1(), "rule__Join__MessageAssignment_4_1");
			builder.put(grammarAccess.getJoinAccess().getPostAssignment_5_2(), "rule__Join__PostAssignment_5_2");
			builder.put(grammarAccess.getJoinAccess().getPostAssignment_5_3_1(), "rule__Join__PostAssignment_5_3_1");
			builder.put(grammarAccess.getJoinAccess().getPreAssignment_6_2(), "rule__Join__PreAssignment_6_2");
			builder.put(grammarAccess.getJoinAccess().getPreAssignment_6_3_1(), "rule__Join__PreAssignment_6_3_1");
			builder.put(grammarAccess.getForkAccess().getNameAssignment_2(), "rule__Fork__NameAssignment_2");
			builder.put(grammarAccess.getForkAccess().getMessageAssignment_4_1(), "rule__Fork__MessageAssignment_4_1");
			builder.put(grammarAccess.getForkAccess().getPostAssignment_5_2(), "rule__Fork__PostAssignment_5_2");
			builder.put(grammarAccess.getForkAccess().getPostAssignment_5_3_1(), "rule__Fork__PostAssignment_5_3_1");
			builder.put(grammarAccess.getForkAccess().getPreAssignment_6_2(), "rule__Fork__PreAssignment_6_2");
			builder.put(grammarAccess.getForkAccess().getPreAssignment_6_3_1(), "rule__Fork__PreAssignment_6_3_1");
			builder.put(grammarAccess.getMergeAccess().getNameAssignment_2(), "rule__Merge__NameAssignment_2");
			builder.put(grammarAccess.getMergeAccess().getMessageAssignment_4_1(), "rule__Merge__MessageAssignment_4_1");
			builder.put(grammarAccess.getMergeAccess().getPostAssignment_5_2(), "rule__Merge__PostAssignment_5_2");
			builder.put(grammarAccess.getMergeAccess().getPostAssignment_5_3_1(), "rule__Merge__PostAssignment_5_3_1");
			builder.put(grammarAccess.getMergeAccess().getPreAssignment_6_2(), "rule__Merge__PreAssignment_6_2");
			builder.put(grammarAccess.getMergeAccess().getPreAssignment_6_3_1(), "rule__Merge__PreAssignment_6_3_1");
			builder.put(grammarAccess.getBranchAccess().getNameAssignment_2(), "rule__Branch__NameAssignment_2");
			builder.put(grammarAccess.getBranchAccess().getMessageAssignment_4_1(), "rule__Branch__MessageAssignment_4_1");
			builder.put(grammarAccess.getBranchAccess().getPostAssignment_5_2(), "rule__Branch__PostAssignment_5_2");
			builder.put(grammarAccess.getBranchAccess().getPostAssignment_5_3_1(), "rule__Branch__PostAssignment_5_3_1");
			builder.put(grammarAccess.getBranchAccess().getPreAssignment_6_2(), "rule__Branch__PreAssignment_6_2");
			builder.put(grammarAccess.getBranchAccess().getPreAssignment_6_3_1(), "rule__Branch__PreAssignment_6_3_1");
			builder.put(grammarAccess.getSeqenceAccess().getNameAssignment_2(), "rule__Seqence__NameAssignment_2");
			builder.put(grammarAccess.getSeqenceAccess().getMessageAssignment_4_1(), "rule__Seqence__MessageAssignment_4_1");
			builder.put(grammarAccess.getSeqenceAccess().getPostAssignment_5_2(), "rule__Seqence__PostAssignment_5_2");
			builder.put(grammarAccess.getSeqenceAccess().getPostAssignment_5_3_1(), "rule__Seqence__PostAssignment_5_3_1");
			builder.put(grammarAccess.getSeqenceAccess().getPreAssignment_6_2(), "rule__Seqence__PreAssignment_6_2");
			builder.put(grammarAccess.getSeqenceAccess().getPreAssignment_6_3_1(), "rule__Seqence__PreAssignment_6_3_1");
			builder.put(grammarAccess.getProcessingResourceAccess().getNameAssignment_2(), "rule__ProcessingResource__NameAssignment_2");
			builder.put(grammarAccess.getProcessingResourceAccess().getResourceAcquireAssignment_4_2(), "rule__ProcessingResource__ResourceAcquireAssignment_4_2");
			builder.put(grammarAccess.getProcessingResourceAccess().getResourceAcquireAssignment_4_3_1(), "rule__ProcessingResource__ResourceAcquireAssignment_4_3_1");
			builder.put(grammarAccess.getProcessingResourceAccess().getResourceReleaseAssignment_5_2(), "rule__ProcessingResource__ResourceReleaseAssignment_5_2");
			builder.put(grammarAccess.getProcessingResourceAccess().getResourceReleaseAssignment_5_3_1(), "rule__ProcessingResource__ResourceReleaseAssignment_5_3_1");
			builder.put(grammarAccess.getProcessingResourceAccess().getStepAssignment_6_2(), "rule__ProcessingResource__StepAssignment_6_2");
			builder.put(grammarAccess.getProcessingResourceAccess().getStepAssignment_6_3_1(), "rule__ProcessingResource__StepAssignment_6_3_1");
			builder.put(grammarAccess.getExternalServiceAccess().getNameAssignment_2(), "rule__ExternalService__NameAssignment_2");
			builder.put(grammarAccess.getExternalServiceAccess().getResourceAcquireAssignment_4_2(), "rule__ExternalService__ResourceAcquireAssignment_4_2");
			builder.put(grammarAccess.getExternalServiceAccess().getResourceAcquireAssignment_4_3_1(), "rule__ExternalService__ResourceAcquireAssignment_4_3_1");
			builder.put(grammarAccess.getExternalServiceAccess().getResourceReleaseAssignment_5_2(), "rule__ExternalService__ResourceReleaseAssignment_5_2");
			builder.put(grammarAccess.getExternalServiceAccess().getResourceReleaseAssignment_5_3_1(), "rule__ExternalService__ResourceReleaseAssignment_5_3_1");
			builder.put(grammarAccess.getExternalServiceAccess().getStepAssignment_6_2(), "rule__ExternalService__StepAssignment_6_2");
			builder.put(grammarAccess.getExternalServiceAccess().getStepAssignment_6_3_1(), "rule__ExternalService__StepAssignment_6_3_1");
			builder.put(grammarAccess.getComponentAccess().getNameAssignment_2(), "rule__Component__NameAssignment_2");
			builder.put(grammarAccess.getComponentAccess().getResourceAcquireAssignment_4_2(), "rule__Component__ResourceAcquireAssignment_4_2");
			builder.put(grammarAccess.getComponentAccess().getResourceAcquireAssignment_4_3_1(), "rule__Component__ResourceAcquireAssignment_4_3_1");
			builder.put(grammarAccess.getComponentAccess().getResourceReleaseAssignment_5_2(), "rule__Component__ResourceReleaseAssignment_5_2");
			builder.put(grammarAccess.getComponentAccess().getResourceReleaseAssignment_5_3_1(), "rule__Component__ResourceReleaseAssignment_5_3_1");
	...
	@Override
	protected InternalMyCsmParser createParser() {
		InternalMyCsmParser result = new InternalMyCsmParser(null);
