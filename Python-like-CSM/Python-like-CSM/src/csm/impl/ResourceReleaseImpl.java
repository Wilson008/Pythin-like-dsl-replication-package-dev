...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Resource Release</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link csm.impl.ResourceReleaseImpl#getGeneralResource <em>General Resource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceReleaseImpl extends StepImpl implements ResourceRelease {
	/**
	...
	protected EClass eStaticClass() {
		return CsmPackage.Literals.RESOURCE_RELEASE;
	}
		...
		if (generalResource != null && generalResource.eIsProxy()) {
			...
			if (generalResource != oldGeneralResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CsmPackage.RESOURCE_RELEASE__GENERAL_RESOURCE, oldGeneralResource, generalResource));
			}
		}
	...
	public NotificationChain basicSetGeneralResource(GeneralResource newGeneralResource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CsmPackage.RESOURCE_RELEASE__GENERAL_RESOURCE, oldGeneralResource, newGeneralResource);
	...
	public void setGeneralResource(GeneralResource newGeneralResource) {
		if (newGeneralResource != generalResource) {
			...
			if (generalResource != null)
				msgs = ((InternalEObject)generalResource).eInverseRemove(this, CsmPackage.GENERAL_RESOURCE__RESOURCE_RELEASE, GeneralResource.class, msgs);
			if (newGeneralResource != null)
				msgs = ((InternalEObject)newGeneralResource).eInverseAdd(this, CsmPackage.GENERAL_RESOURCE__RESOURCE_RELEASE, GeneralResource.class, msgs);
			msgs = basicSetGeneralResource(newGeneralResource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CsmPackage.RESOURCE_RELEASE__GENERAL_RESOURCE, newGeneralResource, newGeneralResource));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CsmPackage.RESOURCE_RELEASE__GENERAL_RESOURCE:
				if (generalResource != null)
					msgs = ((InternalEObject)generalResource).eInverseRemove(this, CsmPackage.GENERAL_RESOURCE__RESOURCE_RELEASE, GeneralResource.class, msgs);
