...
/**
 * This is the item provider adapter for a {@link csm.Workload} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkloadItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Workload_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Workload_value_feature", "_UI_Workload_type"),
				 CsmPackage.Literals.WORKLOAD__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Workload_type") + " " + workload.getValue();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Workload.class)) {
			case CsmPackage.WORKLOAD__VALUE:
