...
entryRuleCSM returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getCSMRule()); }
	iv_ruleCSM=ruleCSM
	{ $current=$iv_ruleCSM.current; }
	EOF;

// Rule CSM
ruleCSM returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_ResourceAcquire_2.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ResourceRelease_3.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleGeneralResource returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getGeneralResourceRule()); }
	iv_ruleGeneralResource=ruleGeneralResource
	{ $current=$iv_ruleGeneralResource.current; }
	EOF;

// Rule GeneralResource
ruleGeneralResource returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_ProcessingResource_1.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ExternalService_2.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRulePathConnection returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getPathConnectionRule()); }
	iv_rulePathConnection=rulePathConnection
	{ $current=$iv_rulePathConnection.current; }
	EOF;

// Rule PathConnection
rulePathConnection returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_Seqence_4.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleScenarion returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getScenarionRule()); }
	iv_ruleScenarion=ruleScenarion
	{ $current=$iv_ruleScenarion.current; }
	EOF;

// Rule Scenarion
ruleScenarion returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleResourceAcquire returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getResourceAcquireRule()); }
	iv_ruleResourceAcquire=ruleResourceAcquire
	{ $current=$iv_ruleResourceAcquire.current; }
	EOF;

// Rule ResourceAcquire
ruleResourceAcquire returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleResourceRelease returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getResourceReleaseRule()); }
	iv_ruleResourceRelease=ruleResourceRelease
	{ $current=$iv_ruleResourceRelease.current; }
	EOF;

// Rule ResourceRelease
ruleResourceRelease returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleSeqence returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSeqenceRule()); }
	iv_ruleSeqence=ruleSeqence
	{ $current=$iv_ruleSeqence.current; }
	EOF;

// Rule Seqence
ruleSeqence returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleProcessingResource returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getProcessingResourceRule()); }
	iv_ruleProcessingResource=ruleProcessingResource
	{ $current=$iv_ruleProcessingResource.current; }
	EOF;

// Rule ProcessingResource
ruleProcessingResource returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleExternalService returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getExternalServiceRule()); }
	iv_ruleExternalService=ruleExternalService
	{ $current=$iv_ruleExternalService.current; }
	EOF;

// Rule ExternalService
ruleExternalService returns [EObject current=null]
@init {
	enterRule();
}
@after {
