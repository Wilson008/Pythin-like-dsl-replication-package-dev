...
public class MyCsmSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MyCsmGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (MyCsmGrammarAccess) access;
