...
public class MyXeniaSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MyXeniaGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (MyXeniaGrammarAccess) access;
