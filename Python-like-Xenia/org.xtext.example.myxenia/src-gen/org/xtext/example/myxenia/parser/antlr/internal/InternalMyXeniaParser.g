...
@after {
	...
	(
		...
		{
			$current = $this_SuperSite_Impl_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
entryRuleSuperSite_Impl returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSuperSite_ImplRule()); }
	iv_ruleSuperSite_Impl=ruleSuperSite_Impl
	{ $current=$iv_ruleSuperSite_Impl.current; }
	EOF;

// Rule SuperSite_Impl
ruleSuperSite_Impl returns [EObject current=null]
@init {
	enterRule();
}
@after {
