...
public class MyXeniaParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyXeniaGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getHeaderAccess().getGroup_3(), "rule__Header__Group_3__0");
			builder.put(grammarAccess.getHeaderAccess().getGroup_4(), "rule__Header__Group_4__0");
			...
			builder.put(grammarAccess.getMappedEntityAccess().getGroup_3(), "rule__MappedEntity__Group_3__0");
			builder.put(grammarAccess.getMappedEntityAccess().getGroup_4(), "rule__MappedEntity__Group_4__0");
			builder.put(grammarAccess.getSuperSite_ImplAccess().getGroup(), "rule__SuperSite_Impl__Group__0");
			builder.put(grammarAccess.getSiteWithModalAccess().getGroup(), "rule__SiteWithModal__Group__0");
			builder.put(grammarAccess.getSiteWithModalAccess().getGroup_4(), "rule__SiteWithModal__Group_4__0");
			...
			builder.put(grammarAccess.getInfoPropertyAccess().getGroup_4(), "rule__InfoProperty__Group_4__0");
			builder.put(grammarAccess.getLinkedPropertyAccess().getGroup(), "rule__LinkedProperty__Group__0");
			builder.put(grammarAccess.getLinkedPropertyAccess().getGroup_3(), "rule__LinkedProperty__Group_3__0");
			builder.put(grammarAccess.getInfoEntityAccess().getGroup(), "rule__InfoEntity__Group__0");
			builder.put(grammarAccess.getInfoEntityAccess().getGroup_3(), "rule__InfoEntity__Group_3__0");
			builder.put(grammarAccess.getInfoEntityAccess().getGroup_4(), "rule__InfoEntity__Group_4__0");
			builder.put(grammarAccess.getRedirectPageAccess().getGroup(), "rule__RedirectPage__Group__0");
			builder.put(grammarAccess.getRedirectPageAccess().getGroup_3(), "rule__RedirectPage__Group_3__0");
			builder.put(grammarAccess.getRedirectPageAccess().getGroup_3_3(), "rule__RedirectPage__Group_3_3__0");
			...
			builder.put(grammarAccess.getModelAccess().getHeadersAssignment_3_0(), "rule__Model__HeadersAssignment_3_0");
			builder.put(grammarAccess.getModelAccess().getHeadersAssignment_3_1(), "rule__Model__HeadersAssignment_3_1");
			builder.put(grammarAccess.getModelAccess().getEntitiesAssignment_4_0(), "rule__Model__EntitiesAssignment_4_0");
			builder.put(grammarAccess.getModelAccess().getEntitiesAssignment_4_1(), "rule__Model__EntitiesAssignment_4_1");
			builder.put(grammarAccess.getModelAccess().getMapped_entitiesAssignment_5_0(), "rule__Model__Mapped_entitiesAssignment_5_0");
			builder.put(grammarAccess.getModelAccess().getMapped_entitiesAssignment_5_1(), "rule__Model__Mapped_entitiesAssignment_5_1");
			builder.put(grammarAccess.getHeaderAccess().getAppNameAssignment_3_1(), "rule__Header__AppNameAssignment_3_1");
			builder.put(grammarAccess.getHeaderAccess().getSitesAssignment_4_0(), "rule__Header__SitesAssignment_4_0");
			builder.put(grammarAccess.getHeaderAccess().getSitesAssignment_4_1(), "rule__Header__SitesAssignment_4_1");
			builder.put(grammarAccess.getEntityAccess().getTechAssignment_3_1(), "rule__Entity__TechAssignment_3_1");
			builder.put(grammarAccess.getEntityAccess().getPathAssignment_4_1(), "rule__Entity__PathAssignment_4_1");
			builder.put(grammarAccess.getEntityAccess().getModeAssignment_5_1(), "rule__Entity__ModeAssignment_5_1");
			builder.put(grammarAccess.getMappedEntityAccess().getInfoPropsAssignment_3_0(), "rule__MappedEntity__InfoPropsAssignment_3_0");
			builder.put(grammarAccess.getMappedEntityAccess().getInfoPropsAssignment_3_1(), "rule__MappedEntity__InfoPropsAssignment_3_1");
			builder.put(grammarAccess.getMappedEntityAccess().getLinkedPropsAssignment_4_0(), "rule__MappedEntity__LinkedPropsAssignment_4_0");
			builder.put(grammarAccess.getMappedEntityAccess().getLinkedPropsAssignment_4_1(), "rule__MappedEntity__LinkedPropsAssignment_4_1");
			builder.put(grammarAccess.getSuperSite_ImplAccess().getNameAssignment_2(), "rule__SuperSite_Impl__NameAssignment_2");
			builder.put(grammarAccess.getSiteWithModalAccess().getNameAssignment_2(), "rule__SiteWithModal__NameAssignment_2");
			builder.put(grammarAccess.getSiteWithModalAccess().getSitesAssignment_4_0(), "rule__SiteWithModal__SitesAssignment_4_0");
			builder.put(grammarAccess.getSiteWithModalAccess().getSitesAssignment_4_1(), "rule__SiteWithModal__SitesAssignment_4_1");
			builder.put(grammarAccess.getSiteAccess().getNameAssignment_2(), "rule__Site__NameAssignment_2");
			builder.put(grammarAccess.getInfoPropertyAccess().getPageAssignment_3_1(), "rule__InfoProperty__PageAssignment_3_1");
			builder.put(grammarAccess.getInfoPropertyAccess().getEntitiesAssignment_4_0(), "rule__InfoProperty__EntitiesAssignment_4_0");
			builder.put(grammarAccess.getInfoPropertyAccess().getEntitiesAssignment_4_1(), "rule__InfoProperty__EntitiesAssignment_4_1");
			builder.put(grammarAccess.getLinkedPropertyAccess().getNameAssignment_3_1(), "rule__LinkedProperty__NameAssignment_3_1");
			builder.put(grammarAccess.getLinkedPropertyAccess().getPageAssignment_4(), "rule__LinkedProperty__PageAssignment_4");
			builder.put(grammarAccess.getInfoEntityAccess().getEntriesAssignment_3_0(), "rule__InfoEntity__EntriesAssignment_3_0");
			builder.put(grammarAccess.getInfoEntityAccess().getEntriesAssignment_3_1(), "rule__InfoEntity__EntriesAssignment_3_1");
			builder.put(grammarAccess.getInfoEntityAccess().getInfoValueAssignment_4_1(), "rule__InfoEntity__InfoValueAssignment_4_1");
			builder.put(grammarAccess.getRedirectPageAccess().getSiteAssignment_3_2(), "rule__RedirectPage__SiteAssignment_3_2");
			builder.put(grammarAccess.getRedirectPageAccess().getSiteAssignment_3_3_1(), "rule__RedirectPage__SiteAssignment_3_3_1");
