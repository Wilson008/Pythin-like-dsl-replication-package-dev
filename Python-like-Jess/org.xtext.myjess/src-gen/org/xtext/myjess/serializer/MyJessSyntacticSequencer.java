...
public class MyJessSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MyJessGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (MyJessGrammarAccess) access;
