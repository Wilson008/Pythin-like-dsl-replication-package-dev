...
/**
 * This is the item provider adapter for a {@link jess.ModuleDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleDefinitionItemProvider extends DefinitionExpItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JessPackage.Literals.MODULE_DEFINITION__MODULE_NAME);
			childrenFeatures.add(JessPackage.Literals.MODULE_DEFINITION__DOCUMENTATION);
		}
	...
	public String getText(Object object) {
		Object labelValue = ((ModuleDefinition)object).getLocation();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JessPackage.Literals.MODULE_DEFINITION__MODULE_NAME,
				 JessFactory.eINSTANCE.createValidIdentifier()));

		newChildDescriptors.add
			(createChildParameter
				(JessPackage.Literals.MODULE_DEFINITION__DOCUMENTATION,
