...
/**
 * This is the item provider adapter for a {@link jess.SlotOp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SlotOpItemProvider extends LocatedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SlotOpItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JessPackage.Literals.SLOT_OP__SLOT_IDENT);
			childrenFeatures.add(JessPackage.Literals.SLOT_OP__OPERATOR);
			childrenFeatures.add(JessPackage.Literals.SLOT_OP__EXP);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SlotOp"));
	}
	...
	public String getText(Object object) {
		Object labelValue = ((SlotOp)object).getLocation();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_SlotOp_type") :
			getString("_UI_SlotOp_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SlotOp.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JessPackage.Literals.SLOT_OP__SLOT_IDENT,
				 JessFactory.eINSTANCE.createSlotName()));

		newChildDescriptors.add
			(createChildParameter
				(JessPackage.Literals.SLOT_OP__OPERATOR,
				 JessFactory.eINSTANCE.createValidIdentifier()));

		newChildDescriptors.add
			(createChildParameter
				(JessPackage.Literals.SLOT_OP__EXP,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == JessPackage.Literals.SLOT_OP__SLOT_IDENT ||
			childFeature == JessPackage.Literals.SLOT_OP__EXP ||
			childFeature == JessPackage.Literals.SLOT_OP__OPERATOR;
