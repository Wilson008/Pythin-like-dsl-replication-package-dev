...
/**
 * This is the item provider adapter for a {@link demodsl.PortGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortGroupItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DemodslPackage.Literals.PORT_GROUP__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DemodslPackage.Literals.PORT_GROUP__PORT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PortGroup.class)) {
			case DemodslPackage.PORT_GROUP__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case DemodslPackage.PORT_GROUP__PORT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DemodslPackage.Literals.PORT_GROUP__PORT,
