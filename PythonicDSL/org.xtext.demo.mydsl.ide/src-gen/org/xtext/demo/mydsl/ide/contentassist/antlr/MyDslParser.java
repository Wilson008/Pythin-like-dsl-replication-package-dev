...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getHardwareComponentAccess().getAlternatives(), "rule__HardwareComponent__Alternatives");
			...
			builder.put(grammarAccess.getSoftwareComponentAccess().getGroup_4(), "rule__SoftwareComponent__Group_4__0");
			builder.put(grammarAccess.getSoftwareComponentAccess().getGroup_5(), "rule__SoftwareComponent__Group_5__0");
			builder.put(grammarAccess.getSoftwareComponentAccess().getGroup_6(), "rule__SoftwareComponent__Group_6__0");
			builder.put(grammarAccess.getSoftwareComponentAccess().getGroup_7(), "rule__SoftwareComponent__Group_7__0");
			builder.put(grammarAccess.getSoftwareComponentAccess().getGroup_8(), "rule__SoftwareComponent__Group_8__0");
			...
			builder.put(grammarAccess.getPowerPortAccess().getGroup(), "rule__PowerPort__Group__0");
			builder.put(grammarAccess.getPowerPortAccess().getGroup_4(), "rule__PowerPort__Group_4__0");
			builder.put(grammarAccess.getFunctionPortAccess().getGroup(), "rule__FunctionPort__Group__0");
			builder.put(grammarAccess.getFunctionPortAccess().getGroup_4(), "rule__FunctionPort__Group_4__0");
			builder.put(grammarAccess.getEIntAccess().getGroup(), "rule__EInt__Group__0");
			builder.put(grammarAccess.getPortConnectorAccess().getGroup(), "rule__PortConnector__Group__0");
			builder.put(grammarAccess.getGroupConnectorAccess().getGroup(), "rule__GroupConnector__Group__0");
			...
			builder.put(grammarAccess.getRootAccess().getHardwarecomponentAssignment_3_2(), "rule__Root__HardwarecomponentAssignment_3_2");
			builder.put(grammarAccess.getRootAccess().getHardwarecomponentAssignment_3_3(), "rule__Root__HardwarecomponentAssignment_3_3");
			builder.put(grammarAccess.getRootAccess().getSoftwarecomponentAssignment_4_0(), "rule__Root__SoftwarecomponentAssignment_4_0");
			builder.put(grammarAccess.getRootAccess().getSoftwarecomponentAssignment_4_1(), "rule__Root__SoftwarecomponentAssignment_4_1");
			builder.put(grammarAccess.getSoftwareComponentAccess().getIdentifierAssignment_2(), "rule__SoftwareComponent__IdentifierAssignment_2");
			builder.put(grammarAccess.getSoftwareComponentAccess().getUUIDAssignment_4_1(), "rule__SoftwareComponent__UUIDAssignment_4_1");
			builder.put(grammarAccess.getSoftwareComponentAccess().getAllocatedToAssignment_5_1(), "rule__SoftwareComponent__AllocatedToAssignment_5_1");
			builder.put(grammarAccess.getSoftwareComponentAccess().getPortAssignment_6_0(), "rule__SoftwareComponent__PortAssignment_6_0");
			builder.put(grammarAccess.getSoftwareComponentAccess().getPortAssignment_6_1(), "rule__SoftwareComponent__PortAssignment_6_1");
			builder.put(grammarAccess.getSoftwareComponentAccess().getPortgroupAssignment_7_0(), "rule__SoftwareComponent__PortgroupAssignment_7_0");
			builder.put(grammarAccess.getSoftwareComponentAccess().getPortgroupAssignment_7_1(), "rule__SoftwareComponent__PortgroupAssignment_7_1");
			builder.put(grammarAccess.getSoftwareComponentAccess().getConnectorAssignment_8_0(), "rule__SoftwareComponent__ConnectorAssignment_8_0");
			builder.put(grammarAccess.getSoftwareComponentAccess().getConnectorAssignment_8_1(), "rule__SoftwareComponent__ConnectorAssignment_8_1");
			builder.put(grammarAccess.getNodeAccess().getIdentifierAssignment_2(), "rule__Node__IdentifierAssignment_2");
			builder.put(grammarAccess.getNodeAccess().getUUIDAssignment_4_1(), "rule__Node__UUIDAssignment_4_1");
			builder.put(grammarAccess.getNodeAccess().getSoftwarecomponentAssignment_5_0(), "rule__Node__SoftwarecomponentAssignment_5_0");
			builder.put(grammarAccess.getNodeAccess().getSoftwarecomponentAssignment_5_1(), "rule__Node__SoftwarecomponentAssignment_5_1");
			builder.put(grammarAccess.getSensorAccess().getIdentifierAssignment_2(), "rule__Sensor__IdentifierAssignment_2");
			builder.put(grammarAccess.getSensorAccess().getUUIDAssignment_4_1(), "rule__Sensor__UUIDAssignment_4_1");
			builder.put(grammarAccess.getActuatorAccess().getIdentifierAssignment_2(), "rule__Actuator__IdentifierAssignment_2");
			builder.put(grammarAccess.getActuatorAccess().getUUIDAssignment_4_1(), "rule__Actuator__UUIDAssignment_4_1");
			builder.put(grammarAccess.getPortGroupAccess().getNameAssignment_1(), "rule__PortGroup__NameAssignment_1");
			builder.put(grammarAccess.getPortGroupAccess().getPortAssignment_3(), "rule__PortGroup__PortAssignment_3");
			builder.put(grammarAccess.getPortGroupAccess().getPortAssignment_4(), "rule__PortGroup__PortAssignment_4");
			builder.put(grammarAccess.getPowerPortAccess().getNameAssignment_2(), "rule__PowerPort__NameAssignment_2");
			builder.put(grammarAccess.getPowerPortAccess().getInputVoltageAssignment_4_1(), "rule__PowerPort__InputVoltageAssignment_4_1");
			builder.put(grammarAccess.getFunctionPortAccess().getNameAssignment_2(), "rule__FunctionPort__NameAssignment_2");
			builder.put(grammarAccess.getFunctionPortAccess().getDirectionAssignment_4_1(), "rule__FunctionPort__DirectionAssignment_4_1");
			builder.put(grammarAccess.getPortConnectorAccess().getPortAssignment_2(), "rule__PortConnector__PortAssignment_2");
			builder.put(grammarAccess.getPortConnectorAccess().getPortAssignment_3(), "rule__PortConnector__PortAssignment_3");
			builder.put(grammarAccess.getGroupConnectorAccess().getPortgroupAssignment_2(), "rule__GroupConnector__PortgroupAssignment_2");
			builder.put(grammarAccess.getGroupConnectorAccess().getPortgroupAssignment_3(), "rule__GroupConnector__PortgroupAssignment_3");
