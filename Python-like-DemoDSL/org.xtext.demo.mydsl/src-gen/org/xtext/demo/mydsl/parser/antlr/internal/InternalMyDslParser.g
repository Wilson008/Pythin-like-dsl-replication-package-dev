...
entryRuleHardwareComponent returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getHardwareComponentRule()); }
	iv_ruleHardwareComponent=ruleHardwareComponent
	{ $current=$iv_ruleHardwareComponent.current; }
	EOF;

// Rule HardwareComponent
ruleHardwareComponent returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_Actuator_2.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
@after {
	...
	(
		...
		{
			$current = $this_PowerPort_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_FunctionPort_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
@after {
	...
	(
		...
		{
			$current = $this_PortConnector_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_GroupConnector_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRulePowerPort returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getPowerPortRule()); }
	iv_rulePowerPort=rulePowerPort
	{ $current=$iv_rulePowerPort.current; }
	EOF;

// Rule PowerPort
rulePowerPort returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleGroupConnector returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getGroupConnectorRule()); }
	iv_ruleGroupConnector=ruleGroupConnector
	{ $current=$iv_ruleGroupConnector.current; }
	EOF;

// Rule GroupConnector
ruleGroupConnector returns [EObject current=null]
@init {
	enterRule();
}
@after {
